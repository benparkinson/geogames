...
public class GeoGeometryTest {
  ...
  public void polygonCoordinates() {
    List<List<List<Double>>> coordinates = List.of(List.of(List.of(12.34, 56.78), List.of(78.9, 12.34)));
  ...
  public void multiPolygonCoordinates() {
    List<List<List<List<Double>>>> coordinates = List.of(List.of(List.of(List.of(12.34, 56.78), List.of(78.9, 12.34))));
